...
class VmFactory(private val repo: FirebaseRepository, private val application: Application? = null) : ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T = when {
        ...
        modelClass.isAssignableFrom(LocationViewModel::class.java) -> LocationViewModel(
            application ?: throw IllegalArgumentException("Application required for LocationViewModel")
        ) as T
